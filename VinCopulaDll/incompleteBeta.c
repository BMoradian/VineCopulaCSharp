...
void inbeder(double* x_in, double* p_in, double* q_in, double* der)
{
  ...
  an = calloc(3, sizeof(double));
  bn = calloc(3, sizeof(double));
  an1 = calloc(3, sizeof(double));
  bn1 = calloc(3, sizeof(double));
  an2 = calloc(3, sizeof(double));
  bn2 = calloc(3, sizeof(double));
  dr = calloc(3, sizeof(double));
  ...
  dan = calloc(3, sizeof(double));
  dbn = calloc(3, sizeof(double));
  der_old = calloc(3, sizeof(double));
  d1 = calloc(3, sizeof(double));
...
// #DUMMYFUNCTIONS incompleteBeta.c

int digamma(double d)
{

}

int lbeta(double p, double q)
{
