...
EXPORTFFUNC void pcc(int* n, int* d, int* family, int* type, double* par, double* nu, double* out);
...
EXPORTFFUNC  void VineLogLikm(int* T, int* d, int* type, int* family, double* par, double* data, double* out, double* ll, double* vv);
...
EXPORTFFUNC void VineLogLikmP(int* T, int* d, int* type, int* family, double* par, int* mpar, double* data,  double* out, double* ll, double* vv);
