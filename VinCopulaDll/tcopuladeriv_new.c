...
*/
	inbeder_out = calloc(3, sizeof(double));
...
// #DUMMYFUNCTIONS tcopuladeriv_new.c

int beta(double value)
{

}

int pbeta(double value1, double value2, double value3, double value4)
{
