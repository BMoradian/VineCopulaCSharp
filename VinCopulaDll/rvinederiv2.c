						  ...
						  double* out, double* ll, double* vv, double* vv2, double* barvalue_out, double* barvdirect_out, double* barvindirect_out, int* tcop, int* kk_second)
{
	...
	// #COMMENTED Commented for undefined Calloc
	...
	zr1=(double*) calloc(*T,sizeof(double));
	zr2=(double*)calloc(*T, sizeof(double));
	handle1=(double*)calloc(*T, sizeof(double));
	helpvar=(double*)calloc(*T, sizeof(double));
	helpvar2=(double*)calloc(*T, sizeof(double));
	helpvar3=(double*)calloc(*T, sizeof(double));
	helpvar4=(double*)calloc(*T, sizeof(double));
	helpvar5=(double*)calloc(*T, sizeof(double));
	helpvar6=(double*)calloc(*T, sizeof(double));
	tildezr1=(double*)calloc(*T, sizeof(double));
	tildezr2=(double*)calloc(*T, sizeof(double));
	tildezr1_hatk_hati=(double*)calloc(*T, sizeof(double));
	tildezr1_tildek_tildei=(double*)calloc(*T, sizeof(double));
	barzr1=(double*) calloc(*T,sizeof(double));
	tildezr2_hatk_hati=(double*)calloc(*T, sizeof(double));
	tildezr2_tildek_tildei=(double*)calloc(*T, sizeof(double));
	barzr2=(double*)calloc(*T, sizeof(double));
	cop=(double*)calloc(*T, sizeof(double));
	der=(double*)calloc(*T, sizeof(double));
	der_hatk_hati=(double*)calloc(*T, sizeof(double));
	der_tildek_tildei=(double*)calloc(*T, sizeof(double));
...
void hesse(int* T, int* d, int* family, int* maxmat, int* matrix, int* condirect, int* conindirect, double* par, double* par2, double* data, double* out, double* subhess, double* der, double* subder)
{
	...
	loglik = calloc(*T, sizeof(double));
	ll = calloc(((*d) * (*d) * (*T)), sizeof(double));
	vv = calloc(((*d) * (*d) * (*T)), sizeof(double));
	vv2 = calloc(((*d) * (*d) * (*T)), sizeof(double));
	calcupdate1 = calloc(((*d) * (*d)), sizeof(int));
	calcupdate2 = calloc(((*d) * (*d)), sizeof(int));
	barvalue_out = calloc(((*d) * (*d) * (*T)), sizeof(double));
	barvdirect_out = calloc(((*d) * (*d) * (*T)), sizeof(double));
	barvindirect_out = calloc(((*d) * (*d) * (*T)), sizeof(double));
	tilde_vdirect = calloc(((*d) * (*d) * (*T)), sizeof(double));
	tilde_vindirect = calloc(((*d) * (*d) * (*T)), sizeof(double));
	tilde_value = calloc(((*d) * (*d) * (*T)), sizeof(double));
	hat_vdirect = calloc(((*d) * (*d) * (*T)), sizeof(double));
	hat_vindirect = calloc(((*d) * (*d) * (*T)), sizeof(double));
	hat_value = calloc(((*d) * (*d) * (*T)), sizeof(double));
